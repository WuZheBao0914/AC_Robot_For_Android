...
public class RobotInfoAdapter extends RecyclerView.Adapter<RobotInfoAdapter.ViewHolder> {
     ...
     */
    public RobotInfoAdapter(SupportActivity activity, List<RobotInfo> dataset) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View v) {
            ...
            mImageView = v.findViewById(R.id.robot_wifi_image);
            ...
            thread = new Thread(new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // TODO 机器人列表页面跳转
                        final Intent intent = new Intent(activity, RobotController.class);
