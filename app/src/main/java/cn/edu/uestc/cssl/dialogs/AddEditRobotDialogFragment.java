...
public class AddEditRobotDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mNameEditTextView = v.findViewById(R.id.robot_name_edit_text);
        mMasterUriEditTextView = v.findViewById(R.id.master_uri_edit_view);
        ...
        mJoystickTopicEditTextView = v.findViewById(R.id.joystick_topic_edit_text);
        mLaserScanTopicEditTextView = v.findViewById(R.id.laser_scan_edit_view);
        mCameraTopicEditTextView = v.findViewById(R.id.camera_topic_edit_view);
        mNavSatTopicEditTextView = v.findViewById(R.id.navsat_topic_edit_view);
        mOdometryTopicEditTextView = v.findViewById(R.id.odometry_topic_edit_view);
        mPoseTopicEditTextView = v.findViewById(R.id.pose_topic_edit_view);
        ...
        builder.setTitle(R.string.add_edit_robot)
                ...
                .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (masterUri.equals("")) {
                            Toast.makeText(getActivity(), "机器人URI不能为空", Toast.LENGTH_SHORT).show();
                            ...
                            Toast.makeText(getActivity(), "话题名称均不能为空", Toast.LENGTH_SHORT).show();
                        } else if (!name.equals("")) {
                            ...
                            Toast.makeText(getActivity(), "机器人名字不能为空", Toast.LENGTH_SHORT).show();
                        }
                    }
